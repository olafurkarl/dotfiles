		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					--    See `:help CursorHold` for information about when this is executedmason
					--
		...
		dependencies = {
			-- Snippet Engine & its associated nvim-cmp source
			{
				...
				config = function()
					...
					local snippetPaths = vim.list_extend(
						vim.api.nvim_get_runtime_file("package.json", true),
						vim.api.nvim_get_runtime_file("snippets/package.json", true)
					)
					for i, str in ipairs(snippetPaths) do
						snippetPaths[i] = string.gsub(str, "/package.json", "")
					end
