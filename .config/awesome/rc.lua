...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Pause", function () awful.spawn(terminalt) end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey,           }, "space", function () awful.spawn(terminalt) end,
              {description = "open a terminal", group = "launcher"}),
    ...
    awful.key({ modkey },            "e",     function () awful.util.spawn(rofimoji_settings) end,
              {description = "run rofimoji prompt", group = "launcher"}),
    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
    ...
    -- Quake terminal
    awful.key({ }, "Pause", function () awful.screen.focused().quake:toggle() end,
