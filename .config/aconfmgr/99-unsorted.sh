...
# Sat Feb  1 16:38:31 GMT 2025 - Unknown packages
...
AddPackage vale # A markup-aware linter for prose built with speed and extensibility in mind
...
# Sat Feb  1 16:38:33 GMT 2025 - Unknown foreign packages


AddPackage --foreign aconfmgr-git # A configuration manager for Arch Linux
AddPackage --foreign bd # Quickly go back to a parent directory instead of typing "cd ../../.." repeatedly
AddPackage --foreign cnijfilter2 # Canon IJ Printer Driver for Linux
AddPackage --foreign discord_arch_electron # Discord using system provided electron for increased security and performance
AddPackage --foreign displaylink # Linux driver for DisplayLink devices
AddPackage --foreign evdi-git # kernel module that enables management of multiple screens, primarily for DisplayLink USB VGA DVI HDMI DisplayPort video
AddPackage --foreign hacked-aio-righty # Hacked-aio Cursor Theme for Righties
AddPackage --foreign inputplug # Xinput hotplug event monitor daemon
...
# Sat Feb  1 16:38:33 GMT 2025 - New / changed files


CreateFile /etc/.pwd.lock 600 > /dev/null
CopyFile /etc/X11/xorg.conf.d/00-keyboard.conf
CreateDir /etc/cni/net.d 700
CopyFile /etc/cups/ppd/Canon_TS3300_series.ppd 640 '' cups
CopyFile /etc/cups/ppd/Canon_TS3300_series_1.050.ppd 640 '' cups
...
CopyFile /etc/hosts
CopyFile /etc/jellyfin/encoding.xml '' jellyfin jellyfin
CopyFile /etc/jellyfin/logging.default.json '' jellyfin jellyfin
CopyFile /etc/jellyfin/migrations.xml '' jellyfin jellyfin
CopyFile /etc/jellyfin/network.xml '' jellyfin jellyfin
CopyFile /etc/jellyfin/system.xml '' jellyfin jellyfin
CopyFile /etc/locale.conf
CopyFile /etc/locale.gen
CreateLink /etc/localtime /usr/share/zoneinfo/Iceland
...
CreateLink /etc/systemd/system/multi-user.target.wants/jellyfin.service /usr/lib/systemd/system/jellyfin.service
...
CreateLink /usr/lib/libcnbpcnclapicom2.so libcnbpcnclapicom2.so.5.0.0
CreateLink /usr/lib/libcnbpnet20.so libcnbpnet20.so.1.0.0
CreateLink /usr/lib/libcnbpnet30.so libcnbpnet30.so.1.0.0
CreateLink /usr/lib/libcncpmslld2.so libcncpmslld2.so.3.0.0
CreateLink /usr/lib/libcncpnet2.so libcncpnet2.so.1.2.4
CreateLink /usr/lib/libcncpnet20.so libcncpnet20.so.1.0.0
CreateLink /usr/lib/libcncpnet30.so libcncpnet30.so.1.0.0
CreateLink /usr/lib/libcnnet2.so libcnnet2.so.1.2.5
CreateLink /usr/lib/libcurl-compat.so.4 libcurl.so.4.7.0
...
CopyFile /usr/lib32/gtk-2.0/2.10.0/immodules.cache
CreateLink /usr/lib32/libcurl-compat.so.4 libcurl.so.4.7.0
...
CreateLink /usr/share/icons/default/cursors /home/olik/.local/share/icons/Future-dark-cursors/cursors
...
CreateFile /var/db/sudo/lectured/1000 600 '' olik > /dev/null
CreateLink /var/lib/dbus/machine-id /etc/machine-id
CopyFile /var/lib/jellyfin/.aspnet/DataProtection-Keys/key-be918c98-873c-4731-a4a4-3e13282bcba8.xml 600 jellyfin jellyfin
CreateDir /var/lib/jellyfin/Subtitle\ Edit/Dictionaries '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/plugins/configurations/Jellyfin.Plugin.MusicBrainz.xml '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/plugins/configurations/Jellyfin.Plugin.Omdb.xml '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/plugins/configurations/Jellyfin.Plugin.StudioImages.xml '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/plugins/configurations/Jellyfin.Plugin.Tmdb.xml '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/root/default/media/media.mblink '' jellyfin jellyfin
CopyFile /var/lib/jellyfin/root/default/media/options.xml '' jellyfin jellyfin
...
# Sat Feb  1 16:38:47 GMT 2025 - New file properties
...
SetFileProperty /usr/share/icons/default/index.theme deleted y
SetFileProperty /var/lib/jellyfin/.aspnet/DataProtection-Keys group jellyfin
SetFileProperty /var/lib/jellyfin/.aspnet/DataProtection-Keys owner jellyfin
SetFileProperty /var/lib/jellyfin/.aspnet group jellyfin
SetFileProperty /var/lib/jellyfin/.aspnet owner jellyfin
SetFileProperty /var/lib/jellyfin/Subtitle\ Edit group jellyfin
SetFileProperty /var/lib/jellyfin/Subtitle\ Edit owner jellyfin
SetFileProperty /var/lib/jellyfin/plugins/configurations group jellyfin
SetFileProperty /var/lib/jellyfin/plugins/configurations owner jellyfin
SetFileProperty /var/lib/jellyfin/plugins group jellyfin
SetFileProperty /var/lib/jellyfin/plugins owner jellyfin
SetFileProperty /var/lib/jellyfin/root/default/media group jellyfin
SetFileProperty /var/lib/jellyfin/root/default/media owner jellyfin
SetFileProperty /var/lib/jellyfin/root/default group jellyfin
SetFileProperty /var/lib/jellyfin/root/default owner jellyfin
SetFileProperty /var/lib/jellyfin/root group jellyfin
SetFileProperty /var/lib/jellyfin/root owner jellyfin
SetFileProperty /var/lib/jellyfin group jellyfin
SetFileProperty /var/lib/jellyfin mode 750
SetFileProperty /var/lib/jellyfin owner jellyfin
